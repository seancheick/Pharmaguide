...
export const PROFILE_SECTIONS: ProfileSectionGroup[] = [
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        icon: 'trophy',
        color: COLORS.primary,
        route: 'HealthGoalsScreen',
      },
      {
        id: 'conditions',
        title: 'Health Conditions',
        description: 'Current and past conditions',
        icon: 'fitness',
        color: COLORS.primary,
        route: 'HealthConditionsScreen',
      },
      {
        id: 'allergies',
        title: 'Allergies',
